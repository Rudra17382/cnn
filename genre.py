...
class CNN():
    ...
    def main(self, dataObject):
        ...
        self.error, self.accuracy = model.evaluate(xTest, yTest, verbose= self.verbose)
    ...
    def hyperParametersToLayers(self, inputShape):
        ...
        for HLayer in self.HiddenLayers:
            try:
                ...
                activation = str(HLayer['activation'])
                dropout = int(HLayer['dropout'])
